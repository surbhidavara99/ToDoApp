module.exports = {
    ...
    "apps": {
      "ios.release": {
        ...
        "build": "export RCT_NO_LAUNCH_PACKAGER=true && xcodebuild -project ios/Firebase_MessageApp.xcodeproj -UseNewBuildSystem=NO -scheme Firebase_MessageApp -configuration Release -sdk iphonesimulator -derivedDataPath ios/build -quiet"
      },
      "ios.debug": {
        "type": "ios.app",
        "binaryPath": "ios/build/Build/Products/Debug-iphonesimulator/Firebase_MessageApp.app",
